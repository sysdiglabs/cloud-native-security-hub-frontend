<template>
  <div>
    ...
    <H2>Alert details</H2>
    To install these alerts in Sysdig Monitor, consult the <a href="https://docs.sysdig.com/en/promql-alerts.html#UUID-7b0f1744-88a0-a4dc-ac88-0bd70008bd18_UUID-9d9d7ee9-2898-a9aa-ea9b-4ab2328f3bf0">following documenattion</a>.
    <prism
